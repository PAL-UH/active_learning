...
def main():
    ...
    dataset_filepath = os.path.join(os.path.dirname(os.path.realpath(__file__)), 'data/supernova.txt')
    ...
    quota = 2000   # Number of samples to query.

    # Model is the base learner, e.g. LogisticRegression, SVM ... etc.
    model = SklearnProbaAdapter(MLPClassifier(solver='lbfgs', alpha=2, random_state=1))
